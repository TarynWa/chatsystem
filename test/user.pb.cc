...
void UserServiceRpc::Resgister(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::RegisterRequest*,
                         ::fixbug::RegisterResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method Resgister() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::Resgister(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
